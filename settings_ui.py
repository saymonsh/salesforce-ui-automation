...
def create_ui(window):
    ...
    ui["PASSWORD"] = pv.PvTextInput(container=window, x=208, y=19, width=171,
        ...
        text_alignment='left', default_text='', paddings=(12, 0, 20, 0), font='assets/fonts/Poppins/Poppins.ttf',
    ...
    ui["URL"] = pv.PvTextInput(container=window, x=18, y=178, width=361,
        ...
        border_style="solid", corner_radius=5, box_shadow='1px 2px 4px 0px rgba(0,0,0,0.2)', icon_path='assets/icons/icon_4.svg',
    ...
    ui["SAVE"] = pv.PvButton(container=window, x=140, y=235, width=120,
        ...
        icon_path='assets/icons/icon_8.svg', icon_position='left', icon_color=(107, 159, 226, 1), icon_color_hover=None,
